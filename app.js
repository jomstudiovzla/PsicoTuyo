// ============================================================
// PsicoTuyo v2.0.0 — App Completa Premium PWA
...
Tu misión es transformar el chat en un diálogo fluido y natural, como una conversación real.`;
    ...
    navItems.forEach(item => {
        item.addEventListener('click', () => {
            ...
            if (targetView === 'social') {
                // Deferred init for community
                if (typeof Gun === 'undefined') {
                    const script = document.createElement('script');
                    script.src = 'https://cdn.jsdelivr.net/npm/gun/gun.js';
                    script.onload = () => initCommunity();
    ...
    function loginSuccess(username, userData) {
        ...
        console.log('PsicoTuyo v2.0.0 — Sesión iniciada:', currentUser);
    }
    ...
    function initVoices() {
        const setVoice = () => {
            ...
            // Debug
            console.log(`Buscando voz para género: ${gender}. Voces disponibles: ${voices.length}`);
            ...
            // Fallback 1: Cualquier voz en español que NO sea el opuesto (si es posible)
            if (!selectedVoice) {
                selectedVoice = voices.find(v => v.lang.startsWith('es'));
            }

            // Fallback 2: Voz por defecto del sistema
    ...
    pwaClearDataBtn.addEventListener('click', () => {
        ...
        for (let i = 0; i < localStorage.length; i++) {
            ...
            if (key.includes(currentUser) || key.includes('psicotuyo')) {
    ...
    function bootApp() {
        ...
        try {
            ...
            if (!loginOverlay || !mainApp) {
                throw new Error('No se encontraron los contenedores principales (loginOverlay/mainApp).');
            }
            ...
            setTimeout(() => {
                ...
                console.log('PsicoTuyo v2.0.0 — Listo.');
            }, 800);
